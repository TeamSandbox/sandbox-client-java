 ...
 * The Class TDSfvu.
 */
public class TDSFVUClient extends RestClient
{

	/**
	 * Instantiates a new TD sfvu.
	 *
	 ...
	 */
	public TDSFVUClient(final ApiSessionCredentials sessionCredentials, final boolean enableDebugLog)
	{
	        ...
	        throws SandboxException
	{
		try
		{
			ApiResponse response = super.postForGet(ENDPOINTS.build(ENDPOINTS.URL.TDS_E_FILE_USING_FVU_ZIP,
	...
	public JSONObject pollJob(final String tan, final String form, final String jobId) throws SandboxException
	{
		...
		try
		{
			ApiResponse response = super.get(ENDPOINTS.build(ENDPOINTS.URL.TDS_E_FILE_FVU_ZIP_RETURN_POLL_JOB,
